...
class ParkingSpotDetector:
    ...
    def region_of_interest(self, image):
        ...
        polygons = np.array([
            [(0, height), (width * 0.3, height), (width * 0.3, height - height * 0.22), (0, height - height * 0.22)],
            [(width * 0.7, height), (width, height), (width, height - height * 0.22), (width * 0.7, height - height * 0.22)],
        ], dtype=np.int32)
